...
struct sv_mod{ 
	...
	int32_t  Ta;				// Output: reference phase-a switching function		
	int32_t  Tb;				// Output: reference phase-b switching function 
	int32_t  Tc;				// Output: reference phase-c switching function
	int32_t  tmp1;				// Variable: temp variable
	int32_t  tmp2;				// Variable: temp variable
	int32_t  tmp3;				// Variable: temp variable
